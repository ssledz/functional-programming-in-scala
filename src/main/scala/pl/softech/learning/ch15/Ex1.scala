...
import pl.softech.learning.ch15.Process1.{Await, Emit, Halt, _}
...
object Ex1 {
  ...
  trait ProcessOps {
    ...
    def take[I](n: Int): Process1[I, I] = {
      def go(acc: Int): Process1[I, I] = Await[I, I] {
    ...
    def takeWhile[I](f: I => Boolean): Process1[I, I] = Await[I, I] {
      case Some(x) if f(x) => Emit(x, takeWhile(f))
      case _ => Halt()
    }

    def dropWhile[I](f: I => Boolean): Process1[I, I] = Await[I, I] {
